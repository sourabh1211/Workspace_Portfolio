...
return (
<div name="resume" className="w-full min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-br from-blue-400 via-indigo-400 to-white">
<div className="max-w-[1000px] mx-auto text-center">
<div className="mb-12">
<h2 className="text-4xl font-bold inline border-b-4 border-gray-400 text-black">
Resume
...
<a
href={resumeUrl}
download="SourabhVerma_Resume.pdf"
className="text-white group border-2 px-6 py-3 my-2 flex items-center justify-center mx-auto w-fit bg-black text-white transition-all duration-300 hover:bg-gray-800 rounded-md shadow-lg transform hover:scale-105"
>
Download Resume <FaFileDownload className="ml-3" />
</a>
<div className="mt-12 w-full h-[600px] rounded-lg overflow-hidden shadow-2xl">

...
const projects = [
  {
    ...
    name: 'SplitShare',
    description: 'SplitShare is an intuitive app designed to simplify group expense management and bill splitting among friends and colleagues.',
    techStack: [<FaReact className="text-cyan-500" />, <FaNodeJs className="text-green-500" />, <SiMongodb className="text-green-600" />, <SiExpress className="text-gray-500" />, <SiJavascript className="text-yellow-500" />],
    github: 'https://github.com/sourabh1211/SplitShare',
    live: 'https://sourabhsplitshare.vercel.app',
    bgColor: 'bg-gradient-to-br from-blue-400 via-indigo-400 to-white',
  },
  {
    id: 2,
    name: 'Codly',
    ...
    github: 'https://github.com/sourabh1211/Codly',
    live: 'https://sourabhcodly.vercel.app',
    bgColor: 'bg-gradient-to-br from-blue-300 via-indigo-400 to-white',
  },
  {
    id: 3,
    name: 'NoteVault',
    ...
    github: 'https://github.com/sourabh1211/NoteVault',
    live: 'https://sourabhnotevault.vercel.app',
    bgColor: 'bg-gradient-to-br from-blue-200 via-indigo-300 to-white',
  },
  {
    id: 4,
    name: 'FinTrack',
    ...
    github: 'https://github.com/sourabh1211/FinTrack',
    live: 'https://sourabhfintrack.vercel.app/login',
    bgColor: 'bg-gradient-to-br from-blue-100 via-indigo-200 to-white',
  },
  {
    id: 5,
    name: 'CodeJourney',
  ...
  },
  {
    ...
    name: 'GitHub Readme',
    description: 'Github readme design',
    techStack: [<SiHtml5 className="text-red-600" />, <SiCss3 className="text-cyan-500" />, <SiJavascript className="text-yellow-500" />],
    github: 'https://github.com/sourabh1211/sourabh1211',
    live: 'https://github.com/sourabh1211/sourabh1211',
    bgColor: 'bg-gradient-to-br from-blue-200 via-indigo-300 to-white',
  },
...
const ProjectCard = ({ name, description, techStack, github, live, bgColor }) => (
  <div className={`${bgColor} backdrop-blur-sm shadow-lg rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl`}> 
    <div className="p-6">
      <h4 className="text-2xl font-bold mb-2 text-black">{name}</h4>
      <p className="text-black mb-4">{description}</p>
      <div className="flex space-x-3 mb-4">
        {techStack.map((icon, index) => (<span key={index} className="text-2xl">{icon}</span>))}
      </div>
      <div className="flex space-x-4">
        <a href={live} target="_blank" rel="noreferrer" className="flex-1 text-center py-2 px-4 bg-blue-500 hover:bg-blue-600 text-black font-semibold rounded-lg transition-colors duration-300 flex items-center justify-center">
          <CgWebsite className="mr-2" /> Live Demo
        </a>
        <a href={github} target="_blank" rel="noreferrer" className="flex-1 text-center py-2 px-4 bg-gray-700 hover:bg-gray-800 text-white font-semibold rounded-lg transition-colors duration-300 flex items-center justify-center">
          <FaGithub className="mr-2" /> GitHub
        </a>
      </div>
    </div>
...
const Projects = () => {
  return (
    <div name="projects" className="w-full min-h-screen py-20 px-4 bg-gradient-to-br from-blue-400 via-indigo-500 to-white">
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold inline-flex items-center justify-center text-black relative z-10">
            <FaLaptopCode className="mr-3 text-5xl text-blue-500" /> Projects
          </h2>
          <p className="py-6 text-lg text-black hover:text-gray-600 transition-colors duration-300">Check out some of my recent work</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

...
<div
name="home"
className="w-full h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 via-indigo-400 to-white px-4 relative overflow-hidden"
>
<div className="max-w-[1200px] w-full flex items-center justify-between">
<div className="w-1/2 text-black text-center sm:text-left sm:px-8">
<p className="text-xl text-gray-700">Hello</p>
...
I'm a
<TypeAnimation
sequence={['Software Developer', 2000, 'Full Stack Developer', 2000, 'Open Source Contributor', 2000]}
wrapper="span"
speed={50}
className="pl-2 text-gray-500"
repeat={Infinity}

...
import React from 'react';
<div name="about" className="w-full min-h-screen py-20 px-4 bg-gradient-to-br from-blue-400 via-indigo-400 to-white">
<div className="max-w-[1200px] mx-auto">
<div className="text-center mb-12">
<h2 className="text-4xl font-bold inline border-b-4 border-gray-600 text-black">About Me</h2>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
<ProfileCard icon={<SiLeetcode className="text-yellow-500" />} name="LeetCode" rating="Knight | 900+ Problems" link="https://leetcode.com/sourabh_1112/" bgColor="bg-yellow-100" shadowColor="shadow-yellow-1000" />
<ProfileCard icon={<SiCodeforces className="text-red-500" />} name="Codeforces" rating="Specialist | 1404" link="https://codeforces.com/profile/sourabh1112" bgColor="bg-red-200" shadowColor="shadow-red-500" />
<ProfileCard icon={<SiCodechef className="text-yellow-600" />} name="CodeChef" rating="3-Star | 1685" link="https://www.codechef.com/users/sourabh_1112" bgColor="bg-yellow-300" shadowColor="shadow-yellow-600" />
<ProfileCard icon={<FaCode className="text-gray-600" />} name="AtCoder" rating="8 Kyu" link="https://atcoder.jp/users/sourabh_1112" bgColor="bg-gray-300" shadowColor="shadow-gray-500" />
</div>
</section>
<section className="mb-12">
<h3 className="text-3xl font-bold text-center mb-8 text-black">Soft Skills</h3>

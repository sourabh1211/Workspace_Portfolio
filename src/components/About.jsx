...
// SkillIcon component (hover color unified)
const SkillIcon = ({ icon, name, bgColor = 'bg-indigo-100/50', hoverColor = 'hover:bg-indigo-200' }) => (
  <div
    className={`flex flex-col items-center p-4 shadow-md rounded-lg transition-all duration-300 ${bgColor} ${hoverColor} relative`}
  >
    <span className="text-4xl mb-2 text-black">{icon}</span>
...
const About = () => {
  return (
    <div name="about" className="w-full min-h-screen py-20 px-4 relative overflow-hidden bg-gradient-to-bl from-indigo-100 via-white to-sky-100">
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold inline border-b-4 border-gray-600 text-black">About Me</h2>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="flex justify-center">
            <div className="w-full md:w-2/3 p-6 bg-indigo-100/50 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
              <div className="flex items-center">
                <img src="/mnnitimage.jpg" alt="MNNIT Allahabad" className="w-1/3 rounded-xl mr-6" />
                <div>
                  <h4 className="text-2xl font-bold text-black">Bachelor of Technology (B.Tech)</h4>
        ...
        <section className="mb-12">
          <h3 className="text-3xl font-bold text-center mb-8 flex items-center justify-center text-black">
            <FaCode className="mr-3 text-indigo-600" /> Professional Skills
          </h3>

          {/* NOTE: hoverColor unified for all SkillIcon instances; bgColor order reversed (indigo -> sky) to match Home palette reversed */}
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
            <SkillIcon icon={<SiCplusplus className="text-indigo-600" />} name="C++" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaHtml5 className="text-sky-500" />} name="HTML5" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaCss3Alt className="text-indigo-600" />} name="CSS3" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaJsSquare className="text-sky-500" />} name="JavaScript" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaReact className="text-indigo-600" />} name="React" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaNodeJs className="text-sky-600" />} name="Node.js" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<SiExpress className="text-indigo-600" />} name="Express" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<SiMongodb className="text-sky-600" />} name="MongoDB" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaGitAlt className="text-indigo-600" />} name="Git" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaGithub className="text-sky-800" />} name="GitHub" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<SiPostman className="text-indigo-600" />} name="Postman" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            />
            <SkillIcon icon={<SiMysql className="text-indigo-600" />} name="SQL (MySQL)" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaRobot className="text-sky-500" />} name="ChatGPT" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<SiFirebase className="text-indigo-600" />} name="Firebase" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaLinux className="text-sky-900" />} name="Linux" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <h3 className="text-3xl font-bold text-center mb-8 text-black flex items-center justify-center">
            <FaLaptopCode className="mr-3 text-indigo-600" /> Coding Profiles
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <ProfileCard
              icon={<SiLeetcode className="text-indigo-600" />}
              name="LeetCode"
              rating="Knight | 900+ Problems"
              link="https://leetcode.com/sourabh_1112/"
            ...
            />
            <ProfileCard
              icon={<SiCodechef className="text-indigo-600" />}
              name="CodeChef"
              rating="3-Star | 1685"
              link="https://www.codechef.com/users/sourabh_1112"
              bgColor="bg-indigo-50"
            ...
            />
            <ProfileCard
              icon={<FaCode className="text-sky-700" />}
              name="AtCoder"
              rating="8 Kyu"
              link="https://atcoder.jp/users/sourabh_1112"
              bgColor="bg-sky-50"
        ...
        <section className="mb-12">
          <h3 className="text-3xl font-bold text-center mb-8 text-black">Soft Skills</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <SkillIcon icon={<FaComments />} name="Communication" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaBrain />} name="Critical Thinking" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaRegLightbulb />} name="Problem Solving" bgColor="bg-indigo-100/50" hoverColor="hover:bg-indigo-200" />
            <SkillIcon icon={<FaClock />} name="Time Management" bgColor="bg-sky-100/50" hoverColor="hover:bg-indigo-200" />
          </div>
        </section>
      </div>
    </div>
